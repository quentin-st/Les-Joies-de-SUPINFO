...
<body>
    <div class="container">
        ...
        <div class="content">
            <div class="gifItem">
                <img src="http://ljdchost.com/cbel57q.gif" alt="Quand je vois les specs du nouveau projet" />
                <div class="catchPhrase">Quand je vois les specs du nouveau projet</div>
            ...
            <div class="gifItem">
                ...
                <div class="gifItemFooter">
                    <div class="submittedBy">louim</div>
                    <div class="submissionDate">01/02/2015</div>
                </div>
            </div>
            <div class="gifItem">
