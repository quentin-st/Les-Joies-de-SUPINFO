...
class GifsController extends Controller
{
	...
	public function getTimeInSecondsUntilNextGif()
	{
		$em = $this->getDoctrine()->getManager();
		...
		$acceptedGifs = $gifRepo->findByGifState(GifState::ACCEPTED);
		...
		// Time diff between now and upcoming publication
		return $upcomingPublication->getTimestamp() - $now->getTimestamp();
	}
}
